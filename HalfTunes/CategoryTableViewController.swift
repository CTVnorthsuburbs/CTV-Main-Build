...
//
// Updated Charlie Rooney June 22nd 2018
//
...
class CategoryTableViewController: UITableViewController
{
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        {
            if(category.videoType == VideoType.youtube) {recommendedVideos = search.getYouTubeVideos(playlist: (categorySection?.sectionPlaylist!)!)!}
            ...
            else {recommendedVideos = search.search((categorySection?.searchID!)! )}
        }
...
extension CategoryTableViewController: UIToolbarDelegate{func positionForBar(bar: UIBarPositioning) -> UIBarPosition {return .topAttached}}// extension CategoryTableViewController: UIToolbarDelegate
